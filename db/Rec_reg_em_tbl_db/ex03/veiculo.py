...
veiculo1 = Veiculo("AAA0001", 2001, "Prata", 1.0, 122333444, marca1.id)
veiculo2 = Veiculo("BAA0002", 2002, "Preto", 1.4, 122333444, marca1.id)
veiculo3 = Veiculo("CAA0003", 2003, "Branco", 2.0, 12345678910, marca2.id)
veiculo4 = Veiculo("DAA0004", 2004, "Azul", 2.2, 99988877766, marca2.id)
