...
class SaborFlash:
    def __init__(self, root):
        self.root = root
        self.root.title("Sabor Flash -Protótipo")
        self.root.geometry("450x500")

        self.itens_menu = {"Hamburguer - R$: 10.00": 10.00, "Batata Frita": 5.00, "Refrigerante": 3.00}
        self.pedido=[]
        ...
        tk.Button(root, text="Adicionar ao Pedido", command=self.adiconar_pedido).pack(pady=5)
